...
from viscoelastic_framework_1D import LinearVEMaterial, BackwardEuler, VE1D, Lagrange
...
for i_eps_dot in eps_dots:
    sigs, eds = sigma(E_inf, E_s, tau, epss, i_eps_dot)
